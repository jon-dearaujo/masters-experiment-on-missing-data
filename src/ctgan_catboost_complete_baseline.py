...
RESULTS_FILE = '../results/ctgan_catboost_completedataset_result.csv'
...
def main():
    ...
    results_log = []
    print(f"🚀 Starting CTGAN-CatBoost complete-data baseline for {ITERATIONS} iterations")
    ...
    for i in range(1, ITERATIONS + 1):
        ...
        X_train, y_train, X_test, y_test, cat_indices = prepare_features(
            synthetic_train,
            D_test,
            TARGET_COL,
            label_encoder,
